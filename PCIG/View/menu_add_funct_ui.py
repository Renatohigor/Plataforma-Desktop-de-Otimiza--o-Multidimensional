...
# Form implementation generated from reading ui file 'menu_add_funct.ui'
#
...
class Ui_Dialog(QtWidgets.QDialog,object):
    ...
    def retranslateUi(self, ):
        ...
        self.label_7.setText(_translate("Dialog", "Minimo"))
        self.label_8.setText(_translate("Dialog", "Maximo"))
        self.label_6.setText(_translate("Dialog", "Dimessões"))
        self.label.setText(_translate("Dialog", "Variavel"))
        ...
        self.label_2.setText(_translate("Dialog", "expreção"))
